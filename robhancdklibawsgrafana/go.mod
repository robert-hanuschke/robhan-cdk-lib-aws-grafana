module github.com/robert-hanuschke/robhan-cdk-lib-aws-grafana/robhancdklibawsgrafana
...
require (
	...
	github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v54 v54.22.0 // indirect
)
